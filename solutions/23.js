 ...
 * @param {number} max Limit
 */
const sumOfNumbersThatCannotBeWrittenAsTheSumOfTwoAbundantNumbers = (numbers, max) => {
  let sum = 0;
...
console.log(
  sumOfNumbersThatCannotBeWrittenAsTheSumOfTwoAbundantNumbers(allAbundantNumbers(limit), limit),
);
